			...
			<div<?php erange_layout_format_div();?>>
				<div class="row">
					<div class="col-md-6 col-sm-6">
						...
						<span>
							<?php echo get_theme_mod('textarea_copyright') ? do_shortcode(get_theme_mod('textarea_copyright')) : 'Design by <a target="_blank" href="http://everislabs.com">EverisLabs</a>. Powered by <a target="_blank" href="http://wordpress.org">WordPress</a>.';?>
						</span><!-- // end span -->
