...
function like_scripts() {
	wp_enqueue_script( 'fast_click', get_template_directory_uri().'/js/fastclick.js', array('jquery'), '0.2', 1 );
	wp_enqueue_script( 'jm_like_post', get_template_directory_uri().'/js/postlike.js', array('jquery'), '1.0', 1 );
