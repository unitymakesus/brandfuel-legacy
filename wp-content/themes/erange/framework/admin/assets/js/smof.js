...
jQuery(document).ready(function($){
	...
	$(".sidebar_add_button").live('click', function(){		
		...
		var newSlide = '<li class="temphide"><div class="slide_header"><strong>Sidebar ' + newNum + '</strong><input type="hidden" class="slide of-input order" name="' + sliderId + '[' + newNum + '][order]" id="' + sliderId + '_slide_order-' + newNum + '" value="' + newNum + '"><a class="slide_edit_button" href="#">Edit</a></div><div class="slide_body" style="display: none;"><label>Name</label><input class="slide of-input of-slider-name" name="' + sliderId + '[' + newNum + '][name]" id="' + sliderId + '_' + newNum + '_slide_name" value=""><label>ID</label><input class="upload slide of-input" name="' + sliderId + '[' + newNum + '][id]" id="' + sliderId + '_' + newNum + '_slide_id" value=""><label>Description</label><textarea class="slide of-input" name="' + sliderId + '[' + newNum + '][description]" id="' + sliderId + '_' + newNum + '_slide_description" cols="8" rows="8"></textarea><a class="slide_delete_button" href="#">Delete</a><div class="clear"></div></div></li>';
