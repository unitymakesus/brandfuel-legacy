					...
					<div class="portfolio-action-inner">
						<ul class="list-unstyled bottom-0">
							...
							<li>
								...
								<a href="<?php echo rwmb_meta('erange_project_link'); ?>"><i class="fa fa-external-link"></i><?php _e('View this projects','erange');?></a>
								<?php endif; ?>
							</li>
							<li><a href="#"><i class="fa fa-briefcase"></i>Create new project</a></li>
						</ul>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-3 bottom-sm-30">
					<div class="heading-area">
						<h5 class="large bottom-0 heading-title"><?php _e('Recent <span>Projects</span>','erange');?></h5>
						<h6 class="heading-subtitle bottom-20"><?php _e('same project you are viewing','erange');?></h6>
					</div><!-- // .heading-area -->

					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error, deleniti earum fugit ipsa nesciunt corporis nobis pariatur aliquam aut aliquid?</p>
