	...
	<tbody>
		...
		<tr>
			<td colspan="6" class="actions">
				...
				<input type="submit" class="left-10 button pull-right" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" /> 
				<input type="submit" class="checkout-button button alt wc-forward pull-right" name="proceed" value="<?php _e( 'Proceed to Checkout', 'woocommerce' ); ?>" />
